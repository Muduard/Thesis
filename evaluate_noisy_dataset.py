...
canny3 = "./results/tesi_canny_noise3"
canny4 = "./results/tesi_canny_noise4"
canny5 = "./results/tesi_canny_noise5"
#base3 = "./results/tesi_base_noise3" # nothing
base3 = "./results/tesi_base_noise3"
base4 = "./results/tesi_base_noise4"
base5 = "./results/tesi_base_noise5"
#tv3 = "./results/tesi_tv_noise3"
tv3 = "./results/tesi_tv13_noise3"
tv4 = "./results/tesi_tv_noise4"
tv5 = "./results/tesi_tv_noise5"
cannytv3 = "./results/tesi_canny_noise_tv3"
cannytv4 = "./results/tesi_canny_noise_tv4"
cannytv5 = "./results/tesi_canny_noise_tv5"
...
mc,pc,sc, = evaluate_dataset(base3)
print(np.mean(mc))
print(np.mean(pc))
print(np.mean(sc))
m.append(mc)
...
print(np.mean(pc))
print(np.mean(sc))
mc,pc,sc, = evaluate_dataset(canny3)
m.append(mc)
p.append(pc)
s.append(sc)
print(np.mean(mc))
print(np.mean(pc))
print(np.mean(sc))
mc,pc,sc, = evaluate_dataset(cannytv3)
m.append(mc)
p.append(pc)
s.append(sc)
print(np.mean(mc))
...
ax[0].boxplot(m)
#ax = plt.boxplot(m)
ax[0].set_xticklabels(['SelfDeblur','TV','Canny', 'Canny + TV'])
ax[0].set_title('MSE')
ax[1].boxplot(p)
ax[1].set_title('PSNR')
#ax = plt.boxplot(m)
ax[1].set_xticklabels(['SelfDeblur','TV','Canny', 'Canny + TV'])
#plt.boxplot(p)

ax[2].boxplot(s)
#ax = plt.boxplot(m)
ax[2].set_title('SSIM')
ax[2].set_xticklabels(['SelfDeblur','TV','Canny', 'Canny + TV'])
#plt.boxplot(s)
plt.show()
"""
plt.clf()
